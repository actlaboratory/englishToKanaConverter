...
* 複合語（接頭辞・接尾辞付きの語を含む）を登録する際、その語を構成する部品が独立した語として既に辞書に登録されている場合は、部品同士の読みとの整合性に注意してください。詳細な考え方は[辞書編集方針（docs/dictionary-policy.md）](./docs/dictionary-policy.md)を参照してください。
